function addMenu(obj, hFig)
    ...
    uimenu(obj.hMenus('EditMenu'), 'Label', 'Delete', 'Callback', @(hO, hE) obj.deleteClusters(), 'Separator', 'on');
    ...
    uimenu(obj.hMenus('EditMenu'), 'Label', 'Reorder clusters by shank then Y', 'Callback', @(hO, hE) obj.reorderClusters('shank then Y'));
